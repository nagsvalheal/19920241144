...
import ARROW_IMG from '@salesforce/resourceUrl/BI_PSPB_ArrowImg';
import UPLOAD_IMAGE from '@salesforce/resourceUrl/BI_PSPB_UploadImg';




//Case 
import FIVE_MB from '@salesforce/label/c.BI_PSPB_FiveLimit';
...
import FILE_TYPE from '@salesforce/label/c.BI_PSPB_FileType';
import SupportCenterUrl from '@salesforce/label/c.BI_PSPB_SupportCenterUrl';
import PspPlaformUrl from '@salesforce/label/c.BI_PSPB_PspPlatformUrl';
import ReportUrl from '@salesforce/label/c.BI_PSPB_ReportUrl';
import MedicalUrl from '@salesforce/label/c.BI_PSPB_MedicalUrl';
import MyCaseUrl from '@salesforce/label/c.BI_PSPB_MyCaseUrl';
...
import ADD_PHOTOS_TEXT from '@salesforce/label/c.BI_PSP_AddYourPhoto';
import FIVE_LIMIT from '@salesforce/label/c.BI_PSPB_FiveLimitFile';
import MAX_FILE_ADD from '@salesforce/label/c.BI_PSPB_MaxFileAdd';
import TOTAL_FILE_SIZE from '@salesforce/label/c.BI_PSPB_TotalFileSize';
import APPLICATION_PDF from '@salesforce/label/c.BI_PSPB_ApplicationPdf';
import PDF_TYPE from '@salesforce/label/c.BI_PSPB_PdfType';
import DELETE_FILE from '@salesforce/label/c.BI_PSPB_DeleteFile';
import LIMIT_REACH from '@salesforce/label/c.BI_PSP_LimitReached';

import ATTACHMENT_HEAD from '@salesforce/label/c.BI_PSPB_AttachmentHead';
